                ...
                return (
                  <Draggable key={item.id} draggableId={item.id} index={idx}>
                    {(provided) => (
                      ...
                      >
                        <button data-index={idx} className='w-6 h-6 my-auto mr-6' onClick={(e) => checked(e)}>
                        ...
                        <p
                          ...
                          onClick={(e) => checked(e)}
                        >
                          {item.status === 'Completed' ? <strike>{item.text}</strike> : item.text}
                          {/* {item.text} {idx} */}
                        </p>

                        <button className='w-6 h-6 my-auto ml-6 ' data-index={idx} onClick={(e) => removeOne(e)}>
